        ...
        function ViewGame(el, game1, opts1) {
            ...
            this.el.dispatch("click", {
                ...
                direct_download_btn: function(_this) {
                    return function(btn) {
                        if (!_this.opts.generate_download_url) {
                            return
                        }
                        return $.ajax({
                            url: _this.opts.generate_download_url,
                            type: "POST",
                            xhrFields: {
...
(function() {
    I.libs.react.done(function() {
        ...
        P("PostLiker", {
            ...
            render: function() {
                ...
                if (!this.props.current_user) {
                    if (!this.props.login_url) {
                        console.warn("Rendering a logged out PostLiker but we don't have the login_url")
                    }
                    return this.enclose({
                        component: "a",
        ...
        P("PostVoter", {
            ...
            render: function() {
                var ref1;
                if (!this.props.current_user && !this.props.login_url) {
                    console.warn("Rendering a logged out PostVoter but we don't have the login_url")
                }
                return this.enclose({
        ...
        P("Post", {
            ...
            get_visible_vote_types: function() {
                ...
                return this.props.post.vote_types
            },
            ...
            render_current_post_contents: function() {
                ...
                return (post.just_added ? R.SlideDown : div)({
                    className: "post_grid"
                }, this.get_visible_vote_types() === "ud" ? P.PostVoter({
                    post_id: post.id,
                    vote: post.vote,
                ...
                }, !this.is_redacted() && this.get_visible_vote_types() === "u" ? P.PostLiker({
                    post_id: post.id,
                    vote: post.vote,
                    urls: this.props.urls,
                    on_vote: this.update_vote,
                ...
                }) : void 0, !this.is_redacted() && !this.props.readonly ? post.can_reply ? a({
                ...
                }, post.is_topic ? this.tt("community.post_list.delete_topic") : this.tt("community.post_list.delete")) : void 0, !this.is_redacted() && post.can_report && !this.props.readonly ? a({
                    href: "#",
